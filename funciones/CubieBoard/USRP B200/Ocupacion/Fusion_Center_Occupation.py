...
class occupation_control():	
	...
	def __init__(self):
		...
		parser.add_argument('-i', '--id_measure', type=float, default=60e3, help="minimun frequency in Hz [default=%default]")
		parser.add_argument('-n', '--min_freq', type=float, default=60e3, help="minimun frequency in Hz [default=%default]")
		parser.add_argument('-x', '--max_freq', type=float, default=3.8e9, help="maximun frequency in Hz")
		...
		parser.add_argument('-c', '--canalization', type=float, default=150e3, help="service canalization")
		parser.add_argument('-p', '--span', type=float, default=20e6, help="span in Hz")
