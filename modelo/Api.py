...
class Api(object):
	...
	resultado1 = self.administrador.correr_funcion(0, funcion, start_frec, final_frec, canalization, span_device,time, 2, id)
	...
	#duration = resultado[15]+30
        return ("<html><head><title>Controlador Simon</title></head><body><h1>Resultados Medicion</h1><table><tr><td><strong>Campo</strong></td><td><strong>Resultado</strong></td></tr>"
    ...
    @cherrypy.expose
    def prueba_url(self):	
        return ("<html><head><title>Ejemplo de tabla sencilla</title></head><body><h1>Listado de cursos</h1><table><tr><td><strong>Curso</strong></td><td><strong>Horas</strong></td><td><strong>Horario</strong></td></tr>"
